...
#include "zxing/bigint/NumberlikeArray.h"  // for NumberlikeArray<>::N
...
unsigned long  BigUnsigned::toUnsignedLong () const { return convertToPrimitive<unsigned long >(*this); }
unsigned int   BigUnsigned::toUnsignedInt  () const { return convertToPrimitive<unsigned int  >(*this); }
unsigned short BigUnsigned::toUnsignedShort() const { return convertToPrimitive<unsigned short>(*this); }
long           BigUnsigned::toLong         () const { return convertToSignedPrimitiveUI<   long >(*this); }
int            BigUnsigned::toInt          () const { return convertToSignedPrimitiveUI<   int  >(*this); }
short          BigUnsigned::toShort        () const { return convertToSignedPrimitiveUI<   short>(*this); }
...
void BigUnsigned::subtract(const BigUnsigned &a, const BigUnsigned &b) {
    ...
    if (b.len == 0) {
        ...
        MB_ASSERTM(false, "%s", "BigUnsigned::subtract: Negative result in unsigned calculation");
    // Some variables...
...
#endif
{
    ...
    MB_ASSERTM(this != &q, "%s", "BigUnsigned::divideWithRemainder: Cannot write quotient and remainder into the same variable");
...
void BigUnsigned::bitShiftLeft(const BigUnsigned &a, int b) {
    ...
    if (b < 0) {
        ...
        MB_ASSERTM(b << 1 != 0, "%s", "BigUnsigned::bitShiftLeft: Pathological shift amount not implemented");
...
void BigUnsigned::bitShiftRight(const BigUnsigned &a, int b) {
    ...
    if (b < 0) {
        ...
        MB_ASSERTM(b << 1 != 0, "%s", "BigUnsigned::bitShiftRight: Pathological shift amount not implemented");
...
void BigUnsigned::operator --() {
    ...
    MB_ASSERTM(len != 0, "%s", "BigUnsigned::operator --(): Cannot decrement an unsigned zero");
