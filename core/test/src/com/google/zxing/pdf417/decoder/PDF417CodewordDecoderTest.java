...
public class PDF417CodewordDecoderTest {
  ...
  private static final int[][] inputValid = {
      { 1, 4, 3, 2, 7, 4, 1, 6 }, { 4, 2, 2, 2, 4, 4, 8, 2 }, { 21, 3, 6, 6, 5, 10, 10, 6 },
      { 22, 3, 5, 14, 5, 3, 9, 6 }, { 17, 3, 5, 3, 9, 3, 8, 18 }, { 2, 2, 3, 1, 4, 6, 8, 2 },
      { 2, 6, 4, 4, 4, 3, 2, 3 }, { 10, 4, 4, 10, 6, 12, 4, 8 }, { 5, 2, 2, 5, 3, 6, 2, 4 },
      { 2, 1, 2, 3, 4, 3, 9, 4 }, { 10, 2, 2, 3, 2, 1, 5, 3 }, { 7, 1, 2, 3, 2, 2, 7, 4 }, { 2, 3, 7, 5, 2, 4, 1, 2 },
      { 7, 2, 1, 2, 1, 3, 8, 1 }, { 2, 2, 2, 8, 8, 6, 2, 4 }, { 8, 2, 2, 2, 3, 7, 2, 9 }, { 5, 1, 13, 5, 8, 13, 8, 3 },
  ...
  private static final int[][] expectedValid = {
      { 1, 2, 2, 1, 5, 2, 1, 3 }, { 3, 1, 1, 1, 3, 2, 5, 1 }, { 5, 1, 1, 2, 1, 3, 2, 2 }, { 5, 1, 1, 4, 1, 1, 2, 2 },
      { 4, 1, 1, 1, 2, 1, 2, 5 }, { 1, 2, 1, 1, 2, 4, 5, 1 }, { 1, 4, 2, 3, 2, 2, 1, 2 }, { 3, 1, 1, 3, 2, 4, 1, 2 },
      { 3, 1, 1, 3, 2, 4, 1, 2 }, { 1, 1, 1, 2, 2, 2, 5, 3 }, { 6, 1, 1, 2, 1, 1, 3, 2 }, { 4, 1, 1, 2, 1, 1, 4, 3 },
      { 1, 2, 5, 3, 2, 2, 1, 1 }, { 5, 1, 1, 1, 1, 2, 5, 1 }, { 1, 1, 1, 4, 4, 3, 1, 2 }, { 4, 1, 1, 1, 1, 4, 1, 4 },
      { 1, 1, 4, 2, 2, 4, 2, 1 }, { 6, 1, 1, 1, 1, 3, 3, 1 }, { 2, 1, 1, 1, 1, 1, 5, 5 }, { 5, 1, 1, 1, 1, 2, 5, 1 },
      { 4, 1, 4, 1, 4, 1, 1, 1 }, { 1, 1, 6, 1, 1, 1, 2, 4 }, { 2, 2, 1, 1, 3, 1, 2, 5 },
  ...
  public void testValues() {
    System.out.println(BitMatrixParser.getCodeword(getDecodedValue(new int[] { 1, 2, 2, 1, 5, 2, 1, 3 })));
  }
